...
Specific steps:
    - Look at the average salary associated with each skills for Data Engineer positions
    - Narrow down the selection to REMOTE Data Engineer jobs, otherwise disregard job location
